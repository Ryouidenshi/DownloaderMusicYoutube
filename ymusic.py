...
def main(args):
    opt = ['help', 'version', 'doubles', 'skip-error', 'colab', 'auth', 'load-cookies=', 'all', 'one=', 'playlist=',
           'sync', 'no-subfolder']
    ...
    for current_argument, current_value in arguments:
        ...
        if current_argument in ('-h', '--help'):
            ...
            opt = list(filter(lambda v: v not in (
            'help', 'doubles', 'skip-error', 'auth', 'load-cookies=', 'colab', 'sync', 'no-subfolder'), opt))
